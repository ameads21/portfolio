...
frameworks = [KeyValue("Bootstrap", "100%"), KeyValue("VSCode", "95%"), KeyValue("Jinja", "90%"), KeyValue("Flask", "80%"), KeyValue(
    "Flask-WTForms", "85%"), KeyValue("Flask-SQLAlchemy", "85%"), KeyValue("Axios", "80%"), KeyValue("PostgreSQL", "75%"), KeyValue("Pandas Python", "75%"),
    KeyValue("Heroku", "70%"), KeyValue("Django", "70%"), KeyValue("Big-O Notation", "70%"), KeyValue("jQuery", "65%"), KeyValue("Express", "35%")]
